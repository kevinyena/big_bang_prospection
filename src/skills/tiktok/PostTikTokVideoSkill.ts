...
import { postVideo } from '../runtime/zernio-api.js';
type PostMode = 'inbox' | 'direct';
...
export const PostTikTokVideoInputSchema = z.object({
  ...
  privacyLevel: z
    ...
    .describe(
      "Niveau de privacy pour le post direct uniquement.",
    ),
});
...
export const PostTikTokVideoOutputSchema = z.object({
  ...
  publicPostUrl: z.string().optional().describe('Lien direct ou URL du post TikTok.'),
