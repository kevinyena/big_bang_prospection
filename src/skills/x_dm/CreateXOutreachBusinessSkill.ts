...
**NICHE OBLIGATOIRE : FOOTBALL / FOOT / SOCCER.** Tous les business générés ciblent l'écosystème foot : fans hardcore, supporters de clubs, joueurs amateurs, coaches, tipsters, créateurs de contenu foot, FPL managers, collectionneurs de maillots, etc.

**Étape 1.** Liste 12 ICPs X-actifs prospectables DANS LE MONDE DU FOOT :
tipsters / pronostiqueurs foot (<10k followers), Fantasy Premier League (FPL) managers actifs, créateurs de contenu foot sur YouTube/TikTok (<10k subs), journalistes foot indé, podcasters foot ligue 1 / amateurs, coaches amateurs / éducateurs jeunes, supporters ultras d'un club spécifique, revendeurs de maillots vintage / collectionneurs, organisateurs de paris entre potes / cagnottes foot, foot analysts / scouts amateurs, gérants de petits comptes stats/tactique, newsletter operators foot (<5k subs), graphistes / créateurs de visuels post-match.

**Étape 2.** Convertis le seed hex en entier modulo 12 → c'est l'INDEX. **Prends celui-là, pas l'évidence.** Conçois le business foot pour cet ICP.

# CONTRAINTES
- Le business doit être 100% ancré dans la culture foot — pas un outil générique repeint en vert
- Le nom de marque doit sonner foot (référence à un terme tactique, ambiance stade, jargon supporter, club, joueur emblématique, etc.)
- Évite les idées sur-saturées (yet another fantasy app, yet another maillot dropshipping)
- Ticket adapté : un fan passionné mais pas riche ne paie pas 999$/mois

# RÈGLES POUR xBioKeywords (CRITIQUE)
- 1-2 mots max par keyword, en minuscules.
- Identités/rôles/niches foot UNIQUEMENT : "foot", "football", "soccer", "supporter", "fan", "tipster", "prono", "fpl", "fantasy", "coach", "ultras", "psg", "real", "barca", "liverpool", "ligue1", "premier", "scout", "tactique", "stats", etc.
- 6-10 keywords mixant 2-3 LARGES (foot/football/fan/supporter) + 3-5 NICHE (tipster/prono/fpl/ultras/scout).
- Test mental : x.com/search?q=KEYWORD&f=user retourne-t-il des centaines de profils foot ? Si non, rejette.
